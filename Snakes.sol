...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minimumTokenBalanceForDividends = 22222 * (10**9); // user must hold 500000 token
...
contract SNAKES is Ownable, IBEP20 {
    using SafeMath for uint256;
    ...
    string constant _name = "Snakes On A NFT Game";
